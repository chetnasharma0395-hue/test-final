...
export const PROGRAMMATIC_ROUTES: ProgrammaticRoute[] = [
...

  {
    ...
    faqs: [
      { question: 'What is the taxi fare from Dehradun to Kedarnath?', answer: 'A sedan is ₹8,500 and an Innova Crysta is ₹11,000 for the 250 km run to Gaurikund (Kedarnath trailhead). Fares are all-inclusive and fixed.' },
...

  {
    ...
    fare: { sedan: 9500, suv: 12500, tempo: null },
    ...
    faqs: [
      { question: 'What is the taxi fare from Dehradun to Badrinath?', answer: 'A sedan is ₹9,500 and an Innova Crysta is ₹12,500 for the 320 km run. All tolls, fuel, and driver allowance are included in the fixed fare.' },
...

  {
    ...
    faqs: [
      { question: 'What is the taxi fare from Dehradun to Jim Corbett?', answer: 'A sedan is ₹5,500 and an SUV is ₹7,000 for the 200 km run to Ramnagar (Jim Corbett). The fare is one-way and fully inclusive.' },
...

  {
    ...
    fare: { sedan: 1800, suv: 2500, tempo: null },
    ...
    faqs: [
      { question: 'What is the taxi fare from Rishikesh to Haridwar?', answer: 'A sedan is ₹1,800 and an SUV is ₹2,500 for the 25 km journey. All fares are fixed and inclusive of fuel and driver allowance.' },
...

  {
    ...
    faqs: [
      { question: 'What is the taxi fare from Rishikesh to Jim Corbett?', answer: 'A sedan is ₹5,000 and an SUV is ₹6,500 for the 185 km run to Ramnagar. Fares are one-way and all-inclusive.' },
...

  {
    ...
    faqs: [
      { question: 'What is the taxi fare from Haridwar to Rishikesh?', answer: 'A sedan is ₹1,800 and an SUV is ₹2,500 for the 25 km journey. The fare is fixed and fully inclusive.' },
...

  {
    ...
    openWindow: 'Apr–Nov',
    distanceKm: 320, travelTime: '10 – 11 hours',
    fare: { sedan: 10000, suv: 13000, tempo: null },
    ...
    faqs: [
      { question: 'What is the taxi fare from Haridwar to Badrinath?', answer: 'A sedan is ₹10,000 and an Innova Crysta is ₹13,000 for the 320 km journey to Badrinath Dham. Fares are fixed and all-inclusive.' },
...

  {
    ...
    faqs: [
      { question: 'What is the taxi fare from Haridwar to Jim Corbett?', answer: 'A sedan is ₹5,500 and an SUV is ₹7,000 for the 200 km run to Ramnagar. Fares are one-way and all-inclusive.' },
