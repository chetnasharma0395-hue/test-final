...
export default function JollyGrantToMussoorieContent() {
  ...
  />
          ...
          <table className="min-w-full bg-[#1A1A1A] border border-white/10 shadow-sm rounded-lg">
            ...
            <tbody>
              <tr>
                ...
                <td className="py-3 px-4 border-b font-medium text-green-600">1.5 – 2.0 Hours</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="py-3 px-4 border-b">Weekend / Peak Season (May-June)</td>
                <td className="py-3 px-4 border-b text-orange-600">2.5 – 3.5 Hours</td>
              </tr>
              <tr className="bg-red-50">
                <td className="py-3 px-4 border-b">Long Weekend or Holiday Rush</td>
                <td className="py-3 px-4 border-b font-bold text-red-600">4.0+ Hours</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b pb-2">2. Local Insights: The 22km Hill Climb</h2>
        ...
        <div className="bg-yellow-50 p-6 rounded-xl border border-yellow-200">
          <h3 className="text-lg font-bold text-yellow-800 mb-2">⚠️ The Motion Sickness Advisory</h3>
      ...
      <section className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-[#1A1A1A] p-5 border rounded-lg shadow-sm">
            <h4 className="font-bold text-blue-700 mb-2">📍 Rajpur Village (Base of the Hill)</h4>
          ...
          <div className="bg-[#1A1A1A] p-5 border rounded-lg shadow-sm">
            <h4 className="font-bold text-blue-700 mb-2">📍 Jharipani / Midway Viewpoints</h4>
        ...
        <ul className="space-y-4">
          <li className="flex items-start">
            ...
            <div>
              ...
              <span className="text-gray-600">Excellent for 1-3 passengers with light luggage. We turn off the AC during steep sections of the hill climb to ensure the engine has maximum climbing power.</span>
            </div>
          </li>
          <li className="flex items-start">
            <span className="text-2xl mr-3">🚙</span>
            <div>
              ...
              <span className="text-gray-600">The supreme choice for 4+ passengers, families, or those prone to motion sickness. The Innova's higher seating position and superior suspension make the winding hill road significantly more comfortable.</span>
            </div>
          </li>
        </ul>
      </section>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b pb-2">5. Arriving in Mussoorie (The "Queen of Hills")</h2>
        <p className="mb-4">Mussoorie is not a single location; it is a 15km ridge. Where you go matters.</p>
        
        <div className="bg-blue-50 p-6 rounded-lg border border-blue-200 mb-6">
          <h3 className="font-bold text-blue-800 mb-3">Local Tips from Our Drivers:</h3>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-700">A: Yes, night arrivals are actually the fastest and smoothest journeys because Dehradun city traffic is gone. Our drivers are hill-certified and familiar with driving the Mussoorie road safely in the dark.</p>
          </div>
          <div>
            <h4 className="font-bold text-lg">Q: What happens if my flight is delayed by 2 hours?</h4>
            <p className="text-gray-700">A: We track your flight number in real-time using radar apps. If your flight is delayed, our driver adjusts their arrival time accordingly. You will not be charged extra for airline delays.</p>
          </div>
          <div>
            <h4 className="font-bold text-lg">Q: Why should I book an Innova if a Dzire is cheaper?</h4>
            <p className="text-gray-700">A: For 2 people with light bags, a Dzire is perfect. However, if you have 4 people or heavy luggage, the Innova's powerful engine, heavy suspension, and larger cabin space make the 22km hairpin ascent vastly more comfortable.</p>
          </div>
        </div>
      </section>
