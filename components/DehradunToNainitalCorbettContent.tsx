...
export default function DehradunToNainitalCorbettContent() {
  ...
  />
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b pb-2">1. The Route: Understanding the Kumaon Gateway</h2>
        <p className="mb-4">
          ...
          <table className="min-w-full bg-[#1A1A1A] border border-white/10 shadow-sm rounded-lg text-left">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="py-3 px-4 border-b font-semibold text-gray-700">To Jim Corbett (Ramnagar)</th>
                <th className="py-3 px-4 border-b font-semibold text-gray-700">To Nainital</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="py-3 px-4 border-b">Normal Weekday (6:00 AM start)</td>
                <td className="py-3 px-4 border-b font-medium text-green-600">5.0 – 5.5 Hours</td>
                <td className="py-3 px-4 border-b font-medium text-green-600">6.5 – 7.0 Hours</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="py-3 px-4 border-b">Weekend / Peak Season</td>
                <td className="py-3 px-4 border-b text-orange-600">6.5 – 7.5 Hours</td>
                <td className="py-3 px-4 border-b text-orange-600">8.0 – 9.0 Hours</td>
              </tr>
              <tr className="bg-red-50">
                <td className="py-3 px-4 border-b">Monsoon / Heavy Rain</td>
                <td className="py-3 px-4 border-b font-bold text-red-600">7.0+ Hours</td>
                <td className="py-3 px-4 border-b font-bold text-red-600">9.0+ Hours</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b pb-2">2. Local Insights: The Highway Reality</h2>
        ...
        <div className="bg-yellow-50 p-6 rounded-xl border border-yellow-200">
          <h3 className="text-lg font-bold text-yellow-800 mb-2">⚠️ Night Driving Advisory</h3>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b pb-2">3. Which Cab Should You Book?</h2>
        ...
        <ul className="space-y-4">
          <li className="flex items-start">
            ...
            <div>
              ...
              <span className="text-gray-600">Adequate for Jim Corbett drops (as the route is flat), provided you have light luggage. We do <em>not</em> recommend sedans for Nainital trips due to the long hill climb and limited boot space for multi-day luggage.</span>
            </div>
          </li>
          <li className="flex items-start">
            <span className="text-2xl mr-3">🚙</span>
            <div>
              ...
              <span className="text-gray-600">This route's ideal vehicle. The Innova's torque handles the UP highway cruising perfectly and conquers the 35km Nainital hill climb effortlessly, ensuring rear passengers remain comfortable and motion-sickness free.</span>
            </div>
          </li>
        </ul>
      </section>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b pb-2">4. Destination Guide: Corbett vs. Nainital</h2>
        
        <div className="space-y-6">
          <div className="bg-green-50 p-6 rounded-lg border border-green-200">
            <h3 className="text-xl font-bold text-green-800 mb-2">🐅 Jim Corbett National Park</h3>
          ...
          <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
            <h3 className="text-xl font-bold text-blue-800 mb-2">🏔️ Nainital (The Lake City)</h3>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-700">A: Technically yes, but we highly discourage it. Doing a morning safari in Ramnagar and then driving 65km up the hill to Nainital leaves you exhausted. We recommend dedicating at least 2-3 days for this combo trip.</p>
          </div>
          <div>
            <h4 className="font-bold text-lg">Q: Are there any border issues entering Uttar Pradesh?</h4>
            <p className="text-gray-700">A: No. Because we use strictly commercial, fully-permitted vehicles, our cars carry the necessary UP state entry permits. Your journey will not be delayed at border checkposts.</p>
          </div>
          <div>
            <h4 className="font-bold text-lg">Q: Will the Innova drop us right at our hotel door on Mall Road in Nainital?</h4>
            <p className="text-gray-700">A: Nainital administration restricts large vehicles from entering Mall Road during most hours. We will drop you safely at the Tallital or Mallital taxi points, where hotel staff or local porters will assist you the short distance to your door.</p>
          </div>
        </div>
      </section>
