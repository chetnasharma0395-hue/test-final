 ...
 *     answer="A taxi from Dehradun to Kedarnath (Gaurikund) costs ₹8,500 for a Sedan and ₹10,500 for an SUV with Uttarakhand Cab 24/7. The fare is fixed and transparent with no hidden charges."
 *     facts={[...]}
 *   />
 */
...
export function GEOAnswerBox({ question, answer, facts = [], source }: GEOAnswerBoxProps) {
  return (
    <div className="bg-[#111827] border border-white/10 rounded-2xl p-6 md:p-8 mb-10">
      {/* Question */}
