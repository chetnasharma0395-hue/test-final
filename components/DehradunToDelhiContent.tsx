...
export default function DehradunToDelhiContent() {
  ...
  />
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b pb-2">1. The Route & Real Road Conditions</h2>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-bold text-gray-800 mb-3 mt-6">The Primary Route (Recommended)</h3>
        ...
        <div className="overflow-x-auto mb-6">
          <table className="min-w-full bg-[#1A1A1A] border border-white/10 shadow-sm rounded-lg">
            <thead className="bg-gray-100">
              <tr>
                <th className="py-3 px-4 border-b text-left font-semibold text-gray-700">Driving Condition</th>
                <th className="py-3 px-4 border-b text-left font-semibold text-gray-700">Estimated Time</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="py-3 px-4 border-b">Normal Weekday (6:00 AM Start)</td>
                <td className="py-3 px-4 border-b font-medium text-green-600">5.5 – 6.5 Hours</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="py-3 px-4 border-b">Peak Season / Weekends</td>
                <td className="py-3 px-4 border-b text-orange-600">7.0 – 8.5 Hours</td>
              </tr>
              <tr>
                <td className="py-3 px-4 border-b">Night Drive (After 10:00 PM)</td>
                <td className="py-3 px-4 border-b font-medium text-blue-600">4.5 – 5.0 Hours</td>
              </tr>
              <tr className="bg-red-50">
                <td className="py-3 px-4 border-b">Kanwar Yatra / Kumbh Mela Period</td>
                <td className="py-3 px-4 border-b font-bold text-red-600">9.0 – 11.0 Hours</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b pb-2">2. Local Driver Insights: What Google Maps Won't Tell You</h2>
        ...
        <div className="bg-yellow-50 p-6 rounded-xl border border-yellow-200">
          <h3 className="text-lg font-bold text-yellow-800 mb-2">⚠️ The Kanwar Yatra Warning (July-August)</h3>
      ...
      <section className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-[#1A1A1A] p-5 border rounded-lg shadow-sm">
            <h4 className="font-bold text-blue-700 mb-2">📍 Stop 1: Roorkee Bypass</h4>
          ...
          <div className="bg-[#1A1A1A] p-5 border rounded-lg shadow-sm">
            <h4 className="font-bold text-blue-700 mb-2">📍 Stop 2: Muzaffarnagar Toll Area</h4>
        ...
        <ul className="space-y-4">
          <li className="flex items-start">
            ...
            <div>
              ...
              <span className="text-gray-600">Ideal for 1-4 passengers with standard luggage. Since this is a flat highway route, a sedan handles it beautifully while offering the most cost-effective fare.</span>
            </div>
          </li>
          <li className="flex items-start">
            <span className="text-2xl mr-3">🚙</span>
            <div>
              ...
              <span className="text-gray-600">The supreme choice for 4-6 passengers, families with children, or heavy luggage. The Innova's superior suspension completely absorbs the rougher patches near Manglaur.</span>
            </div>
          </li>
          <li className="flex items-start">
            <span className="text-2xl mr-3">🚐</span>
            <div>
              ...
              <span className="text-gray-600">Perfect for large corporate groups or extended families. Note: The DME has strict lane restrictions for heavy vehicles. Our drivers know exactly which lanes to use to avoid delays and challans.</span>
            </div>
          </li>
        </ul>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-700">A: Absolutely. Unlike the steep hill routes of Uttarakhand, the road from Haridwar to Delhi is entirely flat plains. Our experienced drivers run night trips regularly. The Delhi-Meerut Expressway is brilliantly lit and highly secure.</p>
          </div>
          <div>
            <h4 className="font-bold text-lg">Q: We are 4 people but have 5 large suitcases. Will a Sedan work?</h4>
            <p className="text-gray-700">A: For 5 large bags, a Sedan will be very cramped. We highly recommend upgrading to an Ertiga or Innova. The price difference is minor, but the comfort upgrade for a 6-hour journey is massive.</p>
          </div>
          <div>
            <h4 className="font-bold text-lg">Q: Why should I book with you instead of a random cab app?</h4>
            <p className="text-gray-700">A: App-based drivers often lack specific route experience. They might not know how to navigate the thick winter fog near Muzaffarnagar, or they might get stuck in Haridwar traffic instead of knowing the bypass shortcuts. We specialize exclusively in Uttarakhand routes. For us, navigating this highway safely is routine.</p>
          </div>
        </div>
      </section>
