...
export default function DehradunToChandigarhContent() {
  ...
  />
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b pb-2">1. The Route: Crossing Three States</h2>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-bold text-gray-800 mb-3 mt-6">The Primary Route (NH-707 & NH-7)</h3>
          ...
          <table className="min-w-full bg-[#1A1A1A] border border-white/10 shadow-sm rounded-lg">
            ...
            <tbody>
              <tr>
                ...
                <td className="py-3 px-4 border-b font-medium text-green-600">3.5 – 4.5 Hours</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="py-3 px-4 border-b">Weekend / Peak Season</td>
                <td className="py-3 px-4 border-b text-orange-600">4.5 – 5.5 Hours</td>
              </tr>
              <tr className="bg-red-50">
                <td className="py-3 px-4 border-b">Heavy Monsoon Days (July-Sept)</td>
                <td className="py-3 px-4 border-b font-bold text-red-600">5.5+ Hours</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b pb-2">2. Local Insights: The Inter-State Reality</h2>
        ...
        <div className="bg-yellow-50 p-6 rounded-xl border border-yellow-200">
          <h3 className="text-lg font-bold text-yellow-800 mb-2">⚠️ The Inter-State Permit Warning</h3>
      ...
      <section className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-[#1A1A1A] p-5 border rounded-lg shadow-sm">
            <h4 className="font-bold text-blue-700 mb-2">📍 Paonta Sahib (HP)</h4>
          ...
          <div className="bg-[#1A1A1A] p-5 border rounded-lg shadow-sm">
            <h4 className="font-bold text-blue-700 mb-2">📍 Kala Amb / Nahan Bypass</h4>
        ...
        <ul className="space-y-4">
          <li className="flex items-start">
            ...
            <div>
              ...
              <span className="text-gray-600">Perfect for 1-4 passengers. The hills on this route are manageable, making a sedan a highly cost-effective and comfortable option.</span>
            </div>
          </li>
          <li className="flex items-start">
            <span className="text-2xl mr-3">🚙</span>
            <div>
              ...
              <span className="text-gray-600">Recommended for larger families, heavy luggage, or elderly passengers. The Innova's suspension provides a noticeably smoother ride during the winding Nahan-Pinjore stretch.</span>
            </div>
          </li>
        </ul>
      </section>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b pb-2">5. Chandigarh Destination Guide</h2>
        ...
        <div className="bg-blue-50 p-6 rounded-lg border border-blue-200 mb-6">
          <h3 className="font-bold text-blue-800 mb-3">Specialized Service: PGI Medical Travel</h3>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-700">A: It is a mix. The first half features a beautiful, slightly winding river valley road. After Paonta Sahib, it flattens out into straight highways until you reach Chandigarh. It is much easier than routes like Kedarnath or Manali.</p>
          </div>
          <div>
            <h4 className="font-bold text-lg">Q: Will the driver drop me inside my specific sector in Chandigarh?</h4>
            <p className="text-gray-700">A: Yes. Whether it is Sector 17, PGI Hospital, Elante Mall, or the Mohali Airport, our fare includes door-to-door drop-off at your exact destination.</p>
          </div>
          <div>
            <h4 className="font-bold text-lg">Q: Is it safe to travel this route during the monsoon?</h4>
            <p className="text-gray-700">A: Generally, yes. However, the Nahan section can occasionally experience minor debris during heavy rains. We monitor weather conditions daily and advise our clients on the safest departure times. In severe weather, we utilize the alternative (but longer) Saharanpur-Ambala highway.</p>
          </div>
        </div>
      </section>
