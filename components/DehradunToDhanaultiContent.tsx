...
export default function DehradunToDhanaultiContent() {
  ...
  />
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-white mb-6 border-b border-white/10 pb-2">1. The Route: Two Destinations, One Journey</h2>
        <p className="mb-4">
          ...
          <table className="min-w-full bg-[#1A1A1A] border border-white/10 shadow-sm rounded-lg text-left">
            <thead className="bg-white/5">
              <tr>
                ...
                <th className="py-3 px-4 border-b font-semibold text-white/70">Dehradun to Mussoorie</th>
                <th className="py-3 px-4 border-b font-semibold text-white/70">Mussoorie to Dhanaulti</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="py-3 px-4 border-b">Normal Weekday (7-8 AM start)</td>
                <td className="py-3 px-4 border-b font-medium text-emerald-400">1.0 – 1.25 Hours</td>
                <td className="py-3 px-4 border-b font-medium text-emerald-400">45 – 55 Mins</td>
              </tr>
              <tr className="bg-[#1A1A1A]">
                <td className="py-3 px-4 border-b">Weekend / Peak Season</td>
                <td className="py-3 px-4 border-b text-[#F7941D]">1.5 – 2.5 Hours</td>
                <td className="py-3 px-4 border-b text-[#F7941D]">1.0 – 1.5 Hours</td>
              </tr>
              <tr className="bg-red-900/20">
                ...
                <td className="py-3 px-4 border-b font-bold text-red-400">1.5 – 2.0 Hours</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-white mb-6 border-b border-white/10 pb-2">2. Local Insights: Avoiding the Bottlenecks</h2>
        ...
        <div className="bg-[#2A1F00] p-6 rounded-xl border border-[#F7941D]/30">
          <h3 className="text-lg font-bold text-[#F7941D] mb-2">⚠️ The Truth About AC in the Hills</h3>
        ...
        <ul className="space-y-4">
          <li className="flex items-start">
            ...
            <div>
              ...
              <span className="text-white/60">Suitable for a day trip to Mussoorie with 1-3 passengers and light bags. However, we do not recommend sedans for Dhanaulti overnight trips with heavy luggage, as the engine feels stressed on the final ridge climbs.</span>
            </div>
          </li>
          <li className="flex items-start">
            <span className="text-2xl mr-3">🚙</span>
            <div>
              ...
              <span className="text-white/60">The supreme choice. The superior ground clearance easily handles broken monsoon patches, and the engine torque effortlessly conquers the steep ascents to Dhanaulti with 6 passengers and full luggage.</span>
            </div>
          </li>
        </ul>
      </section>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-white mb-6 border-b border-white/10 pb-2">5. Destination Guide: Mussoorie & Dhanaulti</h2>
        
        <div className="space-y-6">
          <div>
            <h3 className="text-xl font-bold text-white">Mussoorie's Hidden Gem: Landour</h3>
            <p className="text-white/70">Skip the crowded Kempty Falls. Ask our driver to take you up to <strong>Landour and Char Dukan</strong>. It is the highest point in Mussoorie, featuring quiet British-era cottages, 1800s bakeries, and stunning views of the Kedarnath peaks on a clear winter day.</p>
          </div>
          <div>
            <h3 className="text-xl font-bold text-white">Dhanaulti: The Silent Forest</h3>
            <p className="text-white/70">Dhanaulti is often 4-6°C colder than Mussoorie. Visit the Eco Park for peaceful walks through cedar forests, or ask us about the drive further up to <strong>Kanatal</strong> for ultra-remote, apple-orchard silence.</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-white/70">A: While Mussoorie rarely gets heavy snow, Dhanaulti frequently does between December and February. It is not guaranteed, but a winter trip gives you a 70-80% chance of a winter wonderland.</p>
          </div>
          <div>
            <h4 className="font-bold text-lg">Q: Can we do Mussoorie and Dhanaulti in a single day?</h4>
            <p className="text-white/70">A: Yes, but a 7:00 AM sharp departure from Dehradun is strictly mandatory. This allows you to beat traffic, see Mussoorie in the morning, reach Dhanaulti by noon, and return safely before the evening mountain fog sets in.</p>
          </div>
          <div>
            <h4 className="font-bold text-lg">Q: Is it safe to drive to Dhanaulti at night?</h4>
            <p className="text-white/70">A: We strongly advise against night driving on the Mussoorie-Dhanaulti ridge road. There are no streetlights, and fog can reduce visibility to zero in minutes. Your safety is our absolute priority.</p>
          </div>
        </div>
      </section>
