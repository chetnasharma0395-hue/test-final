          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {allDestinations.map((dest) => (
              <div key={dest.name}>
                <Link 
                  href={dest.link} 
                  className="group flex flex-col h-full bg-[#1A1A1A] rounded-[2rem] shadow-sm hover:shadow-[0_20px_40px_rgba(247,148,29,0.1)] transition-all duration-500 border border-white/10 overflow-hidden relative hover:-translate-y-2"
                >
                  {/* Image Section */}
