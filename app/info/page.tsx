          ...
          <div className="max-w-page mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                { q: 'Jolly Grant Airport to Rishikesh cab fare?', a: 'Starting from ₹1,700 (sedan) · ₹2,300 (SUV). Distance 20 km · 40–45 min. Flight tracking included.', link: '/dehradun-airport-taxi' },
